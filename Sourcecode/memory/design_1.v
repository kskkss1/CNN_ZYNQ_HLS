...
//Date        : Wed Jul 29 20:51:18 2020
//Host        : DESKTOP-ETO14TU running 64-bit major release  (build 9200)
...
(* CORE_GENERATION_INFO = "design_1,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=design_1,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=9,numReposBlks=9,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=1,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=4,da_board_cnt=1,da_bram_cntlr_cnt=2,da_clkrst_cnt=7,da_ps7_cnt=2,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "design_1.hwdef" *) 
module design_1
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
  ...
  wire cnnHLS_0_ap_ready;
  wire [31:0]cnnHLS_0_imginput_PORTA_ADDR;
  wire cnnHLS_0_imginput_PORTA_CLK;
  wire [31:0]cnnHLS_0_imginput_PORTA_DIN;
  wire [31:0]cnnHLS_0_imginput_PORTA_DOUT;
  wire cnnHLS_0_imginput_PORTA_EN;
  wire cnnHLS_0_imginput_PORTA_RST;
  wire [3:0]cnnHLS_0_imginput_PORTA_WE;
  wire [31:0]cnnHLS_0_indexoutput_PORTA_ADDR;
  wire cnnHLS_0_indexoutput_PORTA_CLK;
  wire [31:0]cnnHLS_0_indexoutput_PORTA_DIN;
  wire [31:0]cnnHLS_0_indexoutput_PORTA_DOUT;
  wire cnnHLS_0_indexoutput_PORTA_EN;
  wire cnnHLS_0_indexoutput_PORTA_RST;
  wire [3:0]cnnHLS_0_indexoutput_PORTA_WE;
  ...
  design_1_blk_mem_gen_0_0 blk_mem_gen_0
       (.addra({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,axi_bram_ctrl_0_BRAM_PORTA_ADDR}),
        .addrb(cnnHLS_0_imginput_PORTA_ADDR),
        .clka(axi_bram_ctrl_0_BRAM_PORTA_CLK),
        .clkb(cnnHLS_0_imginput_PORTA_CLK),
        .dina(axi_bram_ctrl_0_BRAM_PORTA_DIN),
        .dinb(cnnHLS_0_imginput_PORTA_DIN),
        .douta(axi_bram_ctrl_0_BRAM_PORTA_DOUT),
        .doutb(cnnHLS_0_imginput_PORTA_DOUT),
        .ena(axi_bram_ctrl_0_BRAM_PORTA_EN),
        .enb(cnnHLS_0_imginput_PORTA_EN),
        .rsta(axi_bram_ctrl_0_BRAM_PORTA_RST),
        .rstb(cnnHLS_0_imginput_PORTA_RST),
        .wea(axi_bram_ctrl_0_BRAM_PORTA_WE),
        .web(cnnHLS_0_imginput_PORTA_WE));
  design_1_blk_mem_gen_0_1 blk_mem_gen_1
       (.addra({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,axi_bram_ctrl_1_BRAM_PORTA_ADDR}),
        .addrb(cnnHLS_0_indexoutput_PORTA_ADDR),
        .clka(axi_bram_ctrl_1_BRAM_PORTA_CLK),
        .clkb(cnnHLS_0_indexoutput_PORTA_CLK),
        .dina(axi_bram_ctrl_1_BRAM_PORTA_DIN),
        .dinb(cnnHLS_0_indexoutput_PORTA_DIN),
        .douta(axi_bram_ctrl_1_BRAM_PORTA_DOUT),
        .doutb(cnnHLS_0_indexoutput_PORTA_DOUT),
        .ena(axi_bram_ctrl_1_BRAM_PORTA_EN),
        .enb(cnnHLS_0_indexoutput_PORTA_EN),
        .rsta(axi_bram_ctrl_1_BRAM_PORTA_RST),
        .rstb(cnnHLS_0_indexoutput_PORTA_RST),
        .wea(axi_bram_ctrl_1_BRAM_PORTA_WE),
        .web(cnnHLS_0_indexoutput_PORTA_WE));
  design_1_cnnHLS_0_1 cnnHLS_0
       (.ap_clk(processing_system7_0_FCLK_CLK0),
        .ap_ready(cnnHLS_0_ap_ready),
        .ap_rst(rst_ps7_0_50M_peripheral_reset),
        .ap_start(axi_gpio_0_gpio2_io_o),
        .img_Addr_A(cnnHLS_0_imginput_PORTA_ADDR),
        .img_Clk_A(cnnHLS_0_imginput_PORTA_CLK),
        .img_Din_A(cnnHLS_0_imginput_PORTA_DIN),
        .img_Dout_A(cnnHLS_0_imginput_PORTA_DOUT),
        .img_EN_A(cnnHLS_0_imginput_PORTA_EN),
        .img_Rst_A(cnnHLS_0_imginput_PORTA_RST),
        .img_WEN_A(cnnHLS_0_imginput_PORTA_WE),
        .indexoutput_Addr_A(cnnHLS_0_indexoutput_PORTA_ADDR),
        .indexoutput_Clk_A(cnnHLS_0_indexoutput_PORTA_CLK),
        .indexoutput_Din_A(cnnHLS_0_indexoutput_PORTA_DIN),
        .indexoutput_Dout_A(cnnHLS_0_indexoutput_PORTA_DOUT),
        .indexoutput_EN_A(cnnHLS_0_indexoutput_PORTA_EN),
        .indexoutput_Rst_A(cnnHLS_0_indexoutput_PORTA_RST),
        .indexoutput_WEN_A(cnnHLS_0_indexoutput_PORTA_WE));
